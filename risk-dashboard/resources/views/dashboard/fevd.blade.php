...
<div class="explainer-card mb-6">
    <div class="explainer-header" onclick="toggleExplainer('explain-fevd')">
        <div class="explainer-header-left">
            ...
            <div>
                <div class="explainer-title">Phân rã phương sai sai số dự báo (FEVD)</div>
                <div class="explainer-subtitle">Mỗi biến đóng góp bao nhiêu % vào biến động của biến mục tiêu?</div>
            </div>
        </div>
    ...
    function renderNullFinding(nf) {
        ...
        el.innerHTML = `
            <div class="flex items-start gap-4">
                ...
                <div>
                    <h3 class="text-sm font-semibold" style="color: var(--color-accent-orange);">Null Finding</h3>
            ...
            wrapper.innerHTML = `
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-xs tabular-nums" style="color: var(--color-text-muted);">
                        Self: ${vData.self_pct_final?.toFixed(1) ?? '—'}% at final horizon
                    </span>
                </div>
                ...
                options: {
                    ...
                    scales: {
                        ...
                        y: {
                            stacked: true,
                            min: 0, max: 100,
                            title: { display: true, text: 'Variance %', color: '#64748b', font: { size: 11 } },
